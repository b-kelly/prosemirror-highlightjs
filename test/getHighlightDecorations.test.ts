...
describe("getHighlightDecorations", () => {
    it("should do basic highlighting", () => {
        const doc = createDoc([{ code: `console.log("hello world!");`, language: "javascript" }]);
        const decorations = getHighlightDecorations(doc, hljs, ["code_block"], (node) => {
    ...
    it("should auto-highlight on an empty language", () => {
        const doc = createDoc([{ code: `System.out.println("hello world!");` }]);
        const decorations = getHighlightDecorations(doc, hljs, ["code_block"], () => null);
    ...
    it("should cancel on non-null prerender", () => {
        const doc = createDoc([{ code: `console.log("hello world!");`, language: "javascript" }]);
        const decorations = getHighlightDecorations(doc, hljs, ["code_block"], () => "javascript", (node, pos) => {
            expect(node).not.toBeNull();
            expect(node.type.name).toBe("code_block");
    ...
    it("should continue on null prerender", () => {
        const doc = createDoc([{ code: `console.log("hello world!");`, language: "javascript" }]);
        const decorations = getHighlightDecorations(doc, hljs, ["code_block"], () => "javascript", () => null);
    ...
    it("should call postrender", () => {
        ...
        const doc = createDoc([{ code: `console.log("hello world!");`, language: "javascript" }]);
        const decorations = getHighlightDecorations(doc, hljs, ["code_block"], () => "javascript", undefined, (node, pos, decos) => {
            expect(node).not.toBeNull();
            expect(node.type.name).toBe("code_block");
