...
export function createStateImpl(input: { code: string, language?: string }[], addPlugins = true) {
...
export function createState(code: string, language?: string, addPlugins = true) {
